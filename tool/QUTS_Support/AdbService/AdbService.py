    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.returnConfig = Common.ttypes.AdbReturnConfig()
...
sendCommand_args.thrift_spec = (
    ...
    (2, TType.STRUCT, 'returnConfig', [Common.ttypes.AdbReturnConfig, None], None, ),  # 2
...
class sendCommand_result(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = Common.ttypes.AdbPacket()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
...
sendCommand_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [Common.ttypes.AdbPacket, None], None, ),  # 0
    (1, TType.STRUCT, 'e', [Common.ttypes.AppException, None], None, ),  # 1
)
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i4 in range(_size0):
                        _elem5 = Common.ttypes.AdbPacket()
                        _elem5.read(iprot)
...
getAllResponsesAsync_result.thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT, [Common.ttypes.AdbPacket, None], False), None, ),  # 0
    (1, TType.STRUCT, 'e', [Common.ttypes.AppException, None], None, ),  # 1
)
